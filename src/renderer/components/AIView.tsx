...
export const ZoixAIView: React.FC = () => {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      console.error('[AIView] Failed to fetch data:', err);
    }
  }, []);
  ...
  const handleToggle = async () => {
    ...
    try {
      ...
      console.error('[AIView] Toggle error:', err);
    }
  };
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      console.log('[AIView] Analysis result:', result);
      fetchData();
    } catch (err) {
      console.error('[AIView] Analysis error:', err);
    } finally {
