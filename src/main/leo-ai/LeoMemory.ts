/**
 * LeoMemory - Persistent learning storage for LEO AI
 *
...
export class LeoMemory {
  ...
  private initialize(): void {
    ...
    console.log('[LeoMemory] Database initialized at:', this.dbPath);
  }
